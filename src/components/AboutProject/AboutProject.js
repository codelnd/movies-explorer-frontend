    ...
    return (
        <section className="about-project" ref={projectRef}>
            ...
            <div className="about-project__wrapper">
                ...
                <article>
                    <h3 className="about-project__title-mini">На выполнение диплома ушло 5 недель</h3>
                    <p className="about-project__paragraph">У каждого этапа был мягкий и жёсткий дедлайн, которые нужно
